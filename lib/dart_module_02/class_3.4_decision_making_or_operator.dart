...
main(){
  ...
  } else if(studentMark < 0 || studentMark <= 32){ // Combine two rules using "or" operator. One of the rule among two rules must be true for entering into this code block.
  if(studentMark < 0) {
